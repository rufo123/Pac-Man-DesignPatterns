...
namespace Pac_Man_DesignPatterns.GhostFactory
{
    public class CyanGhost : GhostFactory
    {
        ...
        {
            return new Cyan(parTexturePath, parXPosition, parYPosition, parScale,  parGhostHousePos, new CyanGhostStrategy(), parCollisionDetector, parFrightenedTexturePath, parDeadTexturePath);
        }
    }
}
